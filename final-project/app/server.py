import time, sys, cherrypy, os, findspark, logging
findspark.init()
...
spark = SparkSession.builder.appName("Music Recommendation Engine").getOrCreate()
...
if __name__ == "__main__":
    ...
    dataset_path = os.path.join(os.getcwd(), 'lastfm-dataset')
